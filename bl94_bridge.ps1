...
$serviceUrlPattern = '(?i)^https?://(?:www\.)?(?:qobuz\.com|tidal\.com|listen\.tidal\.com|deezer\.com|beatport\.com|music\.apple\.com|apple\.com)/'
$lastClipboard = $null
$seenUrls = @{}
...
Write-Host 'RED Purchase Links -> bl94 bridge is running.' -ForegroundColor Yellow
